...
def getNewsHi():
    url=f'https://newsdata.io/api/1/news?apikey=pub_40118922316862ca8ce45e8c136c1b24989c7&language=hi'
    resp = requests.get(url).json()
    print(json.dumps(resp, indent=4))
    # print(resp.json(indent=4))
    if resp.get('status') == 'success' and resp.get('totalResults') > 0:
...
def getNewsSp():
    url=f'https://newsdata.io/api/1/news?apikey=pub_40118922316862ca8ce45e8c136c1b24989c7&language=es'
    resp = requests.get(url).json()
    print(json.dumps(resp, indent=4))
    # print(resp.json(indent=4))
    if resp.get('status') == 'success' and resp.get('totalResults') > 0:
